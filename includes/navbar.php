<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="/assets/img/imgAcc/logo.jpg" alt="logo" width="100">
        </a>

        <button class=" navbar-toggler" type="button" data-bs-toggler="collapse" data-bs-target="#menuNav">
...
<div class=" col row align-item-end "><img src="/assets/img/imgAcc/barreVG.jpg" alt=""></div>